                            ...
                            <div class="grid grid-nogutter">
                                <div v-for="(item, index) in context.dataTable" :key="index" class="col-12">
                                    <div class="flex flex-column sm:flex-row sm:align-items-center p-4 pb-6 gap-3"
                                        ...
                                        <div
                                            class="surface-50 flex justify-content-center align-items-center border-round p-3 md:w-15rem w-full h-8rem">
                                            <div class="md:w-10rem w-full h mx-auto bg-white">
                                                <img class="w-full h-full block border-round" :src="item.urlImg"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    <span class="font-medium text-secondary text-sm">{{ item.ctgrName
                                                        }} • {{ item.brandName }}</span>
                                                    <div class="text-lg font-medium text-900 mt-2">{{ item.productName
                                                        }}</div>
                                                </div>
                                    ...
                                    <div class="p-4 border-1 surface-border surface-card border-round flex flex-column">
                                        <div
                                            ...
                                            <div class="relative mx-auto">
                                                <img class="border-round w-full max-h-6rem" :src="item.urlImg"
                                        ...
                                        <div class="pt-4">
                                            <div class="flex flex-row justify-content-between align-items-start gap-2">
                                                <div>
                                                    ...
                                                    <div class="text-lg font-medium text-900 mt-1">{{ item.productName
                                                        }}</div>
                                                </div>
                                            </div>
