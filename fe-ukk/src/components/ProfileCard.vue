<template>
    ...
    <ul class="list-none p-2 m-0">
        ...
        <li class="mb-2">
            <a v-ripple class="block p-2 font-medium text-700 flex align-items-center hover:surface-50 border-transparent border-1 hover:border-100 border-round cursor-pointer transition-colors transition-duration-150 p-ripple">
