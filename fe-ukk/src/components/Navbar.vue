<template>
    <div class="surface-section shadow-3 relative z-5">
        ...
        <div class="px-3 md:px-3 py-2 w-full flex align-items-center justify-content-between ">
            <img src=" /logo.webp" alt="Logo" class="lg:hidden block border-circle h-3rem border-1 cursor-pointer"
                @click="goToHome" />
            <div class="flex w-full justify-content-end lg:justify-content-between align-items-center gap-3">
                <img src=" /logo.webp" alt="Logo" class="hidden lg:block border-circle h-3rem  cursor-pointer"
                    @click="goToHome" />
                <IconField iconPosition="left" class="w-7 hidden lg:block">
                    <InputIcon class="pi pi-search"> </InputIcon>
                    <InputText v-model="value1" placeholder="Cari menu, pintasan, tema, dan yang lainnya.." class="w-full" @click="showCommandMenu" />
                </IconField>
                ...
                <div
                    class="hidden lg:block absolute lg:static lg:w-auto w-full left-0 top-100 z-1 shadow-2 lg:shadow-none">
                    <ul class="list-none p-0 m-0 flex gap-2">
                        <li>
                            <a v-ripple
                                class="flex px-6 p-3 lg:px-3 align-items-center text-600 hover:text-900 hover:surface-100 font-medium border-round cursor-pointer transition-colors transition-duration-150 p-ripple">
            ...
            <div id="slideover-3"
                class="card hidden surface-overlay absolute top-0 right-0 shadow-2 w-full lg:w-6 lg:hidden"
                style="height: 100vh;">
                <div class="flex flex-column">
                    ...
                    <div class="surface-overlay border-top-1 surface-border">
                        <ul class="list-none p-0 m-0 flex lg:align-items-center select-none flex-column lg:flex-row">
                            <li>
                                <a v-ripple
                                    class="flex px-4 p-3 lg:px-3 lg:py-2 align-items-center text-600 hover:text-900 hover:surface-100 font-medium border-round cursor-pointer transition-colors transition-duration-150 p-ripple"
                                    @click="goToHome">
                            ...
                            <li>
                                <a v-ripple
                                    class="flex px- p-3 lg:px-3 align-items-center text-600 hover:text-900 hover:surface-100 font-medium border-round cursor-pointer transition-colors transition-duration-150 p-ripple"
        ...
        <div id="navbar-7"
            ...
            <ul class="list-none p-0 m-0 flex lg:align-items-center flex-column lg:flex-row select-none">
                <li>
                    <a class="nav-link relative  cursor-pointer flex items-center px-4 py-3 text-gray-500"
